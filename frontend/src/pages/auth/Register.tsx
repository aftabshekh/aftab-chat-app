            ...
            <div className='flex flex-wrap justify-around items-center mt-20'>
                <div>
                    ...
                    <p className='sm:text-2xl text-lg text-center'>
                        Register with us to enjoy realtime chats like no other.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className='mt-6'>
                        ...
                        <div className='my-2'>
                            <label className='flex items-center justify-center cursor-pointer gap-2' htmlFor="image">
                                <img className='w-8' src={displayPicture || avatar} alt="avatar" />
                        ...
                        <div className='w-full flex items-center justify-center mt-6'>
                            <button
                                disabled={loading}
                                className={`${loading ? "" : "active:scale-75"} bg-register text-gray-600 px-6 py-2 rounded-lg font-bold flex items-center justify-center duration-300`}
                            >
                                {loading && (
